...
def update_existing_collection(updated_repl_factor, updated_max_shards_node):
        ...
        if (updated_repl_factor == repl_factor) or (updated_max_shards_node == max_shards_node):
